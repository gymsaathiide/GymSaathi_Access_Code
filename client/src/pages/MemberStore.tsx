...
export default function MemberStore() {
  ...
  const { data: myOrders = [] } = useQuery<any[]>({
    ...
    select: (data: any[]) =>
      data?.filter((order: any) => order.memberId === memberData?.member?.id) ||
      [],
  });
  ...
  const filteredProducts = products
    .filter((product) => {
      ...
      return (
        matchesSearch && matchesCategory && isAvailable && product.isActive
      );
    })
    .sort((a, b) => {
              ...
              <div className="border-t pt-4 space-y-4 mt-auto">
                ...
                <div className="space-y-2">
                  ...
                  {taxAmount > 0 && (
                    <div className="flex justify-between text-sm">
                      <span className="text-muted-foreground">
                        Tax ({settings?.defaultTaxPercent}%):
                      </span>
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      {(settings?.allowCashPayment === 1 ||
                        settings?.allowCashPayment === undefined) && (
            ...
            <>
              ...
              <div className="space-y-4 mt-4">
                ...
                <div className="flex items-center gap-2">
                  <Badge
                    variant={
                      selectedProduct.stock > 0 ? "secondary" : "destructive"
                    }
                  >
