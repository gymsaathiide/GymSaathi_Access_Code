...
const mealCards = [
  {
    ...
    emoji: "🌅",
    icon: Coffee,
    url: "/member/diet-planner/meals/breakfast",
  ...
  },
  {
    ...
    emoji: "☀️",
    icon: Sun,
    url: "/member/diet-planner/meals/lunch",
  ...
  },
  {
    ...
    emoji: "🌙",
    icon: Moon,
    url: "/member/diet-planner/meals/dinner",
    gradient: "from-purple-500 via-indigo-500 to-blue-600",
    description: "End your day healthy"
  }
];

export default function DietMealsLandingPage() {
  return (
