  ...
  const generateSlugMutation = useMutation({
    mutationFn: async () => {
      ...
      const response = await apiRequest(
        "POST",
        `/api/gyms/${gymInfo.id}/generate-slug`,
      );
    ...
    navigator.clipboard
      ...
      .then(() => {
        toast({
          title: "Link Copied!",
          description:
            "Share this link on Instagram, WhatsApp, or your website. New enquiries will appear here automatically.",
        });
      })
      .catch(() => {
        toast({
  ...
  return (
    <div className="space-y-6 p-5 pb-20">
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent className="max-w-xs bg-[hsl(220,26%,16%)] border-white/10 text-white">
                <p>
                  Share this link on Instagram, WhatsApp, or your website. New
                  enquiries come here automatically.
                </p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
      ...
      <div className="grid gap-2 sm:gap-4 grid-cols-2 sm:grid-cols-3 lg:grid-cols-5">
        <Card
          className="cursor-pointer bg-card-dark border-white/5 hover:bg-white/5 transition-colors"
        ...
        <Card
          className="cursor-pointer bg-card-dark border-white/5 hover:bg-white/5 transition-colors col-span-2 sm:col-span-1"
          ...
          <div className="mb-4 flex flex-col sm:flex-row gap-3">
            ...
            <div className="flex gap-2">
              <Select value={statusFilter} onValueChange={setStatusFilter}>
                <SelectTrigger
                  className="w-full sm:w-[140px] bg-white/5 border-white/10 text-white text-sm"
                ...
                {leads.map((lead) => (
                  ...
                  >
                    <div className="flex items-start justify-between gap-2 mb-2 ">
                      ...
                      <Badge
                        className={`${getStatusBadgeClass(lead.status)} text-xs`}
                      ...
                      >
                        {canEdit && (
                          <Button
                            variant="ghost"
                            size="sm"
                            className="h-7 px-2 hover:bg-white/10 text-white/60"
                        ...
                        {canConvert && lead.status !== "converted" && (
                          <Button
                            variant="ghost"
                            size="sm"
                            className="h-7 px-2 hover:bg-green-500/10 text-white/60 hover:text-green-400"
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="border-white/5 hover:bg-white/5">
                      ...
                      <TableHead className="hidden md:table-cell text-white/60">
                        Email
                      </TableHead>
