...
export default function AdminDashboardNew() {
  ...
  const analyticsData =
    dashboard?.classes.attendanceLast7Days?.map((day) => ({
      month: new Date(day.date).toLocaleDateString("en-IN", {
        weekday: "short",
      }),
      value: day.checkins,
    })) || [];
      ...
      <div className="space-y-6 ">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <ShopOrdersPanel
            ...
            completedOrders={
              (dashboard.shop?.ordersToday || 0) -
              (dashboard.shop?.pendingOrders || 0)
            }
